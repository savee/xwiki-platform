...
public class SolrSearchService implements SearchService, EventListener
{
    ...
    /**
     * Highlight seperator set to XWiki bold syntax. Hit highlighting returns **SEARCH_TEXT**
     */
    private static final String HIGHLIGHT_SYNTAX = "**";
     ...
     * @param params map of solr query params
     * @return the solr query
     */
    public SolrQuery getSolrQuery(String query, Map<String, String> params)
    {
        SolrQuery squery = new SolrQuery();
        squery.setQuery(query).setFacet(true);
        squery.addFacetField("title_en", "title_fr", "title_es", "ft_en", "ft_fr", "ft_es");

        for (String paramKey : params.keySet()) {
            squery.setParam(paramKey, params.get(paramKey));
        }
     ...
     * {@inheritDoc}
     * 
     * @see org.xwiki.platform.search.SearchService#queryDocument(java.lang.String, java.lang.String)
     */
    public List<String> queryDocument(String query, String qfvalues)
    {
        Map<String, String> params = new HashMap<String, String>();
        params.put("qf", qfvalues);
        params.put("deftype", DEF_TYPE);
        params.put("qt", DEF_TYPE);
        params.put("hl.simple.pre", HIGHLIGHT_SYNTAX);
        params.put("hl.simple.post", HIGHLIGHT_SYNTAX);
        SolrQuery squery = getSolrQuery(query, params);
